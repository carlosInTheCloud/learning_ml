---
type: Guideline
title: "Goal: Graduate-Level Machine Learning Mastery"
...
# Goal: Graduate-Level Machine Learning Mastery
...
### 3. Graduate-Level Academic Pedagogy
...
This repository names **Stanford University's CS229, CS230, CS231n, and CS224n** to describe the level of rigor and depth it aims at. That is the whole of the relationship.

This project is **not affiliated with, endorsed by, or sponsored by Stanford University**, and it is **not a substitute for those courses** or for any university program. It confers no credential. The course names are used descriptively — to say how hard the material should be and how much ground it should cover — and for no other purpose.

All material here is derived independently. See the originality rule in [conventions.md](conventions.md).
